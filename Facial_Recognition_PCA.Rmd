---
title: "Facial Recognition: Principal Component Analysis."
...
2. [Mean center the image matrix]
3. [Perform SVD of the mean centered image matrix]
    + [Use scree plot to find k.]
    + [See how distorted images are by using diffrent k values.]
4. [Classifying Test Images]
5. [Measure the distance between Vnew and V for each of the training images]
    + [Using k=20.]
    + [Using k=15.]
    + [Using k=13.]
...
load("~/OneDrive - MNSCU/Unsupervised_Learning_DSCI415/Assignmenet4/Facial-Recognition-PCA/Olivetti.rdata")
```
...
```{r image plot first 10 subjects}
